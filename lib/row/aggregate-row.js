...
function (_shouldUpdater) {
  ...
  function RowAggregator(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RowAggregator).call(this, props));
    _this.clickNum = 0;
  ...
  _createClass(RowAggregator, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["row", "columns", "keyField", "rowIndex", "style", "className", "attrs", "selectRow", "expandRow", "expanded", "expandable", "selected", "selectable", "visibleColumnSize", "tabIndexCell"]);
      ...
      var childrens = [_react["default"].createElement(_rowPureContent["default"], _extends({
        key: "row",
        row: row,
        columns: columns,
        keyField: keyField,
      ...
      if (!hideSelectColumn) {
        var selectCell = _react["default"].createElement(_selectionCell["default"], _extends({}, selectRow, {
          key: "selection-cell",
          rowKey: key,
          rowIndex: rowIndex,
          selected: selected,
      ...
      if (showExpandColumn) {
        var expandCell = _react["default"].createElement(_expandCell["default"], _extends({}, expandRow, {
          key: "expand-cell",
          rowKey: key,
          rowIndex: rowIndex,
          expanded: expanded,
