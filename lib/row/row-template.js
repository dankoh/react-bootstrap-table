...
var RowTemplate = function RowTemplate(props) {
  ...
  if (selectRow && selectRow.hideSelectColumn !== true) {
    if (isRenderFunctionColumnInLeft(selectRow.selectColumnPosition)) {
      childrens.unshift(_react["default"].createElement(cellEl, {
        key: 'selection'
      }));
    } else {
      childrens.push(_react["default"].createElement(cellEl, {
        key: 'selection'
      }));
    }
  }
  ...
  return _react["default"].createElement("tr", rest, childrens);
};
