...
var ExpandRow = function ExpandRow(_ref) {
  ...
  return _react["default"].createElement("tr", null, _react["default"].createElement("td", _extends({
    className: (0, _classnames["default"])('reset-expansion-style', className)
  }, rest), _react["default"].createElement(_reactTransitionGroup.CSSTransition, {
    appear: true,
    "in": expanded,
    timeout: 400,
