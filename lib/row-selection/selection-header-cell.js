...
function (_Component) {
  ...
  function SelectionHeaderCell() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SelectionHeaderCell).call(this));
  ...
  _createClass(SelectionHeaderCell, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement(_bootstrap.BootstrapContext.Consumer, null, function (_ref2) {
        ...
        if (selectionHeaderRenderer) {
          ...
          content = _react["default"].createElement(CheckBox, _extends({}, _this2.props, {
            checked: checked,
