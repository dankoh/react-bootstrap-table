...
var _default = function _default(Component) {
  var renderWithSelection = function renderWithSelection(props, selectRow) {
    ...
    if (selected) {
      ...
      style = _objectSpread({}, style, {}, selectedStyle);
    ...
    if (notSelectable) {
      ...
      style = _objectSpread({}, style, {}, notSelectableStyle);
  ...
  function withConsumer(props) {
    return _react["default"].createElement(_selectionContext["default"].Consumer, null, function (selectRow) {
