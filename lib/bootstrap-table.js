...
function (_PropsBaseResolver) {
  ...
  function BootstrapTable(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(BootstrapTable).call(this, props));
  ...
  _createClass(BootstrapTable, [{
    ...
    value: function render() {
      ...
      if (overlay) {
        ...
        return _react["default"].createElement(LoadingOverlay, null, this.renderTable());
      }
    ...
    value: function renderTable() {
      ...
      var tableCaption = caption && _react["default"].createElement(_caption["default"], {
      ...
      }, tableCaption, _react["default"].createElement(_header["default"], {
        columns: columns,
      ...
      }), hasFilters && filterPosition !== _const["default"].FILTERS_POSITION_INLINE && _react["default"].createElement(_filters["default"], {
        columns: columns,
      ...
      }), hasFooter && _react["default"].createElement(_footer["default"], {
        data: this.getData(),
        columns: columns,
        selectRow: selectRow,
        expandRow: expandRow,
