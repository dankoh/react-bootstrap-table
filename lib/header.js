...
var Header = function Header(props) {
  ...
  var childrens = [columns.map(function (column, i) {
    ...
    return _react["default"].createElement(_headerCell["default"], {
      index: i,
  ...
  if (!selectRow.hideSelectColumn) {
    if (isRenderFunctionColumnInLeft(selectRow.selectColumnPosition)) {
      childrens.unshift(_react["default"].createElement(SelectionHeaderCellComp, {
        key: "selection"
      }));
    } else {
      childrens.push(_react["default"].createElement(SelectionHeaderCellComp, {
        key: "selection"
      }));
    }
  }
  ...
  if (expandRow.showExpandColumn) {
    if (isRenderFunctionColumnInLeft(expandRow.expandColumnPosition)) {
      childrens.unshift(_react["default"].createElement(ExpansionHeaderCellComp, {
        key: "expansion"
      }));
    } else {
      childrens.push(_react["default"].createElement(ExpansionHeaderCellComp, {
        key: "expansion"
      }));
    }
  }
